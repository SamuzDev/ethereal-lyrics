...
install() {
    ...
    echo -e "${PURPLE}╔═══════════════════════════════════════════════════════════╗${NC}"
    echo -e "${PURPLE}║                                                           ║${NC}"
    echo -e "${PURPLE}║${CYAN}    _____ _               _                  _             ${PURPLE}║${NC}"
    echo -e "${PURPLE}║${CYAN}   / ____| |             | |                | |            ${PURPLE}║${NC}"
    echo -e "${PURPLE}║${CYAN}  | (___ | |__   __ _  __| | ___  _ __   ___| |_ ___ _ __ ${PURPLE}║${NC}"
    echo -e "${PURPLE}║${CYAN}   \\___ \\| '_ \\ / _\` |/ _\` |/ _ \\| '_ \\ / _ \\ __/ _ \\ '__|${PURPLE}║${NC}"
    echo -e "${PURPLE}║${CYAN}   ____) | | | | (_| | (_| | (_) | | | |  __/ ||  __/ |   ${PURPLE}║${NC}"
    echo -e "${PURPLE}║${CYAN}  |_____/|_| |_|\\__,_|\\__,_|\\___/|_| |_|\\___|\\__\\___|_|   ${PURPLE}║${NC}"
    echo -e "${PURPLE}║                                                           ║${NC}"
    echo -e "${PURPLE}║${PINK}     Synced Spotify lyrics for your terminal               ${PURPLE}║${NC}"
    echo -e "${PURPLE}║                                                           ║${NC}"
    echo -e "${PURPLE}╚═══════════════════════════════════════════════════════════╝${NC}"
    echo ""
