...
install() {
    ...
    echo -e "${PURPLE}╔══════════════════════════════════════════════════════╗${NC}"
    echo -e "${PURPLE}║                                                      ║${NC}"
    echo -e "${PURPLE}║${CYAN}         ___________ _                                 ${PURPLE}║${NC}"
    echo -e "${PURPLE}║${CYAN}        |  ___|  _  \ |                                ${PURPLE}║${NC}"
    echo -e "${PURPLE}║${CYAN}        | |__ | | | || |__   ___                      ${PURPLE}║${NC}"
    echo -e "${PURPLE}║${CYAN}        |  __|| | | || '_ \ / _ \                     ${PURPLE}║${NC}"
    echo -e "${PURPLE}║${CYAN}        | |___| |/ /| |_) |  __/                      ${PURPLE}║${NC}"
    echo -e "${PURPLE}║${CYAN}        \____/|___/ |_.__/ \___|                       ${PURPLE}║${NC}"
    echo -e "${PURPLE}║                                                      ${PURPLE}║${NC}"
    echo -e "${PURPLE}║${WHITE}       ══════════════════════════════════════         ${PURPLE}║${NC}"
    echo -e "${PURPLE}║${DIM}       ║ Synced Spotify Lyrics for Terminal ║         ${PURPLE}║${NC}"
    echo -e "${PURPLE}║${WHITE}       ══════════════════════════════════════         ${PURPLE}║${NC}"
    echo -e "${PURPLE}║                                                      ║${NC}"
    echo -e "${PURPLE}╚══════════════════════════════════════════════════════╝${NC}"
    echo ""
